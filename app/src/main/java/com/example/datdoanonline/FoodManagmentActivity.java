...
import com.example.datdoanonline.adapter.MyAdapter;
...
//                                    lstMonAn.add(snapshot.getValue(MonAn.class));
                                ...
                                public void onChildChanged(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                                    for(int j = 0; j < lstMonAn.size(); j++){
                                        lstMonAn.set(j, snapshot.getValue(MonAn.class));
                                        Toast.makeText(FoodManagmentActivity.this, "Sửa Thành công", Toast.LENGTH_SHORT).show();
                                        lstMonAn.clear();
                                    }
                                }
