...
public class UserMainActivity extends AppCompatActivity {
    ...
    private Button btnEditAccount, btnLogout, btnPasswordChange, btnAllFood, btnFriedFood, btnFastFood, btnDrinks, btnCart, btnOrder, btnKhac;
...
//        final ImageView foodIMG = findViewById(R.id.foodIMG);
        ...
        btnEditAccount = findViewById(R.id.btnAccountInfo);
        btnCart = findViewById(R.id.btnCart);
        btnLogout = findViewById(R.id.btnLogout);
        txtUserName = findViewById(R.id.txtUserName);
        btnPasswordChange = findViewById(R.id.btnPasswordChange);
        foodGridview = findViewById(R.id.foodGrid);
        btnAllFood = findViewById(R.id.btnAllFood);
        btnFastFood = findViewById(R.id.btnFastFood);
        btnFriedFood = findViewById(R.id.btnFriedFood);
        btnDrinks = findViewById(R.id.btnDrink);
...
//                handler.postDelayed(this, delay);
    ...
    protected void onResume() {
        ...
        btnKhac.setOnClickListener(KhacClick);
...
//                handler.postDelayed(this, delay);
    ...
    View.OnClickListener KhacClick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            lstMonAn.clear();
            databaseReference = FirebaseDatabase.getInstance().getReference();
            databaseReference.child("Food").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                        if(dataSnapshot.getValue(MonAn.class).getiType() == 0){
                            MonAn monAn = dataSnapshot.getValue(MonAn.class);
                            lstMonAn.add(monAn);
                        }
                    }
