...
public class AdminAccountEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_account_edit_layout);
                    ...
                    databaseReference.child("User").addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                            if(snapshot.getValue(UserData.class).getsUserName().equals(sUserName)){
                                ...
                                intent = new Intent(AdminAccountEdit.this,UserMainActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                startActivity(intent);
                                Toast.makeText(AdminAccountEdit.this, "Cập nhật thông tin thành công!", Toast.LENGTH_SHORT).show();
                            }
                        }
