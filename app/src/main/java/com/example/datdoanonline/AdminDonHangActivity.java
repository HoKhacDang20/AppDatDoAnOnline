...
import com.example.datdoanonline.adapter.AdminDonHangAdapter;
...
public class AdminDonHangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_don_hang_layout);
...
//                    Toast.makeText(AdminDonHangActivity.this, donHangArrayList.get(i).getsHoTen(), Toast.LENGTH_SHORT).show();
    ...
    public void DonHangLoad(){
        ...
        adminDonHangAdapter = new AdminDonHangAdapter(this, R.layout.admin_don_hang_item_layout,donHangArrayList,blackListArrayList);
