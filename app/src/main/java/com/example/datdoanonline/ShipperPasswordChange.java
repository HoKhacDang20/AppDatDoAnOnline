...
public class ShipperPasswordChange extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shipper_password_change_layout);
                    ...
                    databaseReference.child("User").addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                            if(snapshot.getValue(UserData.class).getsUserName().equals(sUserName) && snapshot.getValue(UserData.class).getsPassword().equals(sOldPassword)){
                                ...
                                intent = new Intent(ShipperPasswordChange.this,LoginActivity.class);
                                intent.setFlags(intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                startActivity(intent);
                                Toast.makeText(ShipperPasswordChange.this, "Cập nhật mật khẩu thành công!", Toast.LENGTH_SHORT).show();
                            }
                        }
