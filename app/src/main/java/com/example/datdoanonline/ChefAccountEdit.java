...
public class ChefAccountEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chef_account_edit_layout);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(v.getContext(),KitchenActivity.class);
                    ...
                    databaseReference.child("User").addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                            if(snapshot.getValue(UserData.class).getsUserName().equals(sUserName)){
                                ...
                                intent = new Intent(ChefAccountEdit.this,UserMainActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                startActivity(intent);
                                Toast.makeText(ChefAccountEdit.this, "Cập nhật thông tin thành công!", Toast.LENGTH_SHORT).show();
                            }
                        }
